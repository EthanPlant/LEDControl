/*==============================================================================
	UBMP 2.0 (PIC16F1459) configuration bit settings.
...
// PIC16F1459 Configuration Bit settings generated by MPLABX for UBMP version 2.
// These settings must be exactly identical to those in the bootloader program
// if a bootloader is being used.
